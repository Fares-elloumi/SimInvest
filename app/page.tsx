...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="min-h-[60vh] w-full p-10 flex flex-col items-center gap-6 bg-gradient-to-br from-space-dark via-space-teal to-space-dark lg:flex-row lg:gap-30 lg:pr-30">
        <div className="flex flex-col items-center text-center w-full md:mx-auto md:items-start text-space-light gap-4">
          <h1 className="text-3xl font-bold text-space-light lg:text-left lg:text-5xl">Lär dig investering utan risk med <span className="text-white">100 000 SEK</span> i demokapital</h1>
          <h2 className="text-space-light mb-4 lg:text-left lg:text-2xl">Upplev spänningen i investeringsmarknaden utan att riskera riktiga pengar. Vår simulator ger dig realtidsdata och verktygen du behöver för att bli en expert.</h2>
        </div>
